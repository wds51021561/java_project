  ...
  <div class="sell-main">
    ...
    <div class="sell-table">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="" label="售后入库订单编号" width="150">
        </el-table-column>
        <el-table-column prop="" label="售后入库订单类型" width="120">
        </el-table-column>
        <el-table-column prop="" label="对应出库订单编号" width="120">
        </el-table-column>
        <el-table-column prop="" label="售后入库订单状态" width="120">
        </el-table-column>
    ...
    <el-dialog title="创建出库单" :visible.sync="formFlog" width="80%">
      ...
      <el-table :data="goodTable" border style="width: 100%">
        ...
        <el-table-column prop="" label="返厂前串码" width="150">
        </el-table-column>
        <el-table-column prop="" label="返厂后串码" width="150">
        </el-table-column>
        <el-table-column prop="" label="录入串码" width="120">
          <el-input  />
        </el-table-column>
      </el-table>
      <el-form>
