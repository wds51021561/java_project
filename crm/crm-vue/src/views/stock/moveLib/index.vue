<template>
  <div class="sell-main">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="createForm(scope.row)" v-if="true">生成移库单</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="创建移库单" :visible.sync="formFlog" width="1350px">
      ...
      <el-form :inline="true" :model="queryForm" class="demo-form-inline">
        ...
        <el-form-item label="商品串口号">
          <el-input v-for="index in form.goodSerial.length" :key="form.goodSerial[index]" v-model="form.goodSerial[index]"/>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" @click="addSerial">添加商品串口号</el-button>
        </el-form-item>
